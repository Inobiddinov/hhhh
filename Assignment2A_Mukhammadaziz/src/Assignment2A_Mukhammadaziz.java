...
class DisplayAll {
    ...
    public void displayNewOrder() {
        ...
        if (dispatcherNumber < 10)
            System.out.print("0" + (totalOrder[dispatcherNumber] + 1));
        else
            System.out.print((totalOrder[dispatcherNumber] + 1));
    ...
    public void modifyOrder() {
        ...
        do {
            ...
            if (modifyName > 3 || modifyName < 1) {
                System.out.println("Invalid dispatcher No.");
                Validation = false;
            }
